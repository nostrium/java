...
- [Fight the stone Golem](#opponent-stone-golem)
...
- If A:Health < 0 then "You have lost"; A:Coins = 0; #scene-end
- If B:Health < 0 then write "You have won!"; A:Coins = A:Coins + 10; #scene-azurath-entrance
